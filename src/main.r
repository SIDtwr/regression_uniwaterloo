...
ggplot(covid_data) +
  geom_point(aes(INDEX, CASES, col = "Original-points")) +
  geom_line(aes(INDEX, CASES, col = "Original-line")) +
  ...
  scale_colour_manual("",
                      breaks = c("Original-points", "Original-line", "Order 1","Order 2","Order 3","Order 4"),
                      values = c("black","black","cyan","blue","orange","green")) +
  theme_bw()
